...
#define OUDERKERK_EXP_MULTIPLIER    10         // Flat multiplier applied to all EXP gained from battles (wild + trainer). Ouderkerk-specific QoL setting, not part of the Gen-config system above — raise/lower this one number to retune leveling speed.
