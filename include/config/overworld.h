...
#define OW_FLAG_NO_TRAINER_SEE      FLAG_DEBUG_NO_TRAINER_SEE  // If this flag is set, trainers will not battle the player unless they're talked to. Wired to the OUDERKERK_DEBUG_IGNORE_TRAINERS build toggle, see spec.md's "Debug options".
