...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_SCHOOL_KID] = { _("HAL LEERLING") },
    ...
    [TRAINER_CLASS_TRIATHLETE] = { _("FIETSER"), 10 },
    [TRAINER_CLASS_TENNISSER] = { _("TENNISSER"), 15, BALL_ULTRA },
    ...
    [TRAINER_CLASS_MAGMA_LEADER] = { _("NAM"), 20, BALL_MASTER },
